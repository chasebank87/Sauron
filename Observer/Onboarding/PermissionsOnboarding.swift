...
struct PermissionsOnboarding: View {
    ...
    private var headerCopy: String {
        if permissions.allGranted {
            return "You're ready. Observer can sit in the menu bar and capture meetings on this Mac."
        }
        return "Grant access so Observer can sit in the menu bar and capture meetings on this Mac."
    }

...
struct WaveConfig: Sendable {
    ...
    var maxAmplitude: Double = 0.92
    var windowExponent: Double = 1.55
    var wavelengthCoupling: Double = 0.75
    var idlePhaseScale: Double = 0.4
    var lineWidth: Double = 1.6
    /// Near-symmetric envelope — rise and fall both feel flowy.
    var targetTau: Double = 0.10
    var attackTau: Double = 0.15
    var releaseTau: Double = 0.18
...
struct ReactiveWaveformLine: View {
    ...
    private var strokeColor: Color {
        isAlert ? Color.orange : ObserverTheme.accent
    }
                ...
                TimelineView(.animation(minimumInterval: 1.0 / 60.0, paused: false)) { timeline in
                    ...
                    Canvas { context, size in
                        ...
                        context.stroke(
                            ...
                            with: .linearGradient(
                                Gradient(colors: [
                                    ObserverTheme.accentStart.opacity(isAlert ? 0.6 : 0.9),
                                    strokeColor
                                ]),
                                startPoint: .zero,

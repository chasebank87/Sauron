...
enum MCPJSONRPC {
    ...
    static let serverName = "observer-memory"
...
enum MemoryMCPHints {
    ...
    Observer meeting memory is available via MCP tools: search_meetings, get_meeting, list_recent_meetings, memory_status.

            ...
            LazyVStack(alignment: .leading, spacing: 16) {
                if meetings.isEmpty {
                    DashboardEmptyState(
                        ...
                        actionTitle: "Ask Observer instead",
                        ...
                        Button { selectedDay = day } label: {
                            VStack(spacing: 3) {
                                Text("\(calendar.component(.day, from: day))")
                                    ...
                                    .foregroundStyle(ObserverTheme.textPrimary)
                                Circle()
                                    .fill(count > 0 ? ObserverTheme.irisSolid : Color.clear)
        ...
        ScrollView {
            LazyVGrid(columns: [GridItem(.adaptive(minimum: 240), spacing: 12)], spacing: 12) {
                ForEach(meetings) { meeting in
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ZStack(alignment: .topTrailing) {
                            RoundedRectangle(cornerRadius: 12, style: .continuous)
                                .fill(ObserverTheme.irisGradient.opacity(0.2))
                                .frame(height: 88)
                    ...
                    .padding(12)
                    .background(
                        (checked || selectedMeetingID == meeting.id) ? ObserverTheme.surfaceElevated : ObserverTheme.surface,
                    ...
                    .overlay(
                        RoundedRectangle(cornerRadius: ObserverTheme.radiusCard, style: .continuous)
                            .strokeBorder(
                                checked ? ObserverTheme.irisSolid.opacity(0.55) : ObserverTheme.hairline,
                                lineWidth: 1
                            )
                    )

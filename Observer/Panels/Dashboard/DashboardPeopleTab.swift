    ...
    private func personCard(_ profile: SpeakerProfile, meetings: [Meeting], selected: Bool) -> some View {
        ...
        return VStack(alignment: .leading, spacing: 12) {
            HStack(spacing: 12) {
                ZStack {
                    Circle()
                        .strokeBorder(ObserverTheme.irisGradient, lineWidth: 2)
        ...
        .padding(14)
        .background(selected ? ObserverTheme.surfaceElevated : ObserverTheme.surface, in: RoundedRectangle(cornerRadius: ObserverTheme.radiusCard, style: .continuous))
        .overlay(

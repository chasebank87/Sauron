...
extension View {
    ...
    func observerSurfaceCard(elevated: Bool = false) -> some View {
        self
            .background(
                elevated ? SauronTheme.surfaceElevated : SauronTheme.surface,
            ...
            .overlay(
                RoundedRectangle(cornerRadius: SauronTheme.radiusCard, style: .continuous)
                    .strokeBorder(SauronTheme.hairline, lineWidth: 1)
            )
    }
    ...
    func observerDashboardCanvas() -> some View {
        self.background {
            ZStack {
                ...
                RadialGradient(
                    colors: [
                        SauronTheme.irisEnd.opacity(0.06),
                        SauronTheme.irisStart.opacity(0.03),
                        .clear
                    ],
                    center: .topLeading,
                    startRadius: 20,
